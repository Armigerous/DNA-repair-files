...
# List of file names
file_names = [
    "NTS_NHF1_CPD_CSB_XR_1.bed.csv",
    "NTS_NHF1_CPD_CSB_XR_2.bed.csv",
    "NTS_NHF1_CPD_XPC_XR_1.bed.csv",
    "NTS_NHF1_CPD_XPC_XR_2.bed.csv",
    "NTS_NHF1_CPD_XR_1.bed.csv",
    "NTS_NHF1_CPD_XR_2.bed.csv",
    "TS_NHF1_CPD_CSB_XR_1.bed.csv",
    "TS_NHF1_CPD_CSB_XR_2.bed.csv",
    "TS_NHF1_CPD_XPC_XR_1.bed.csv",
    "TS_NHF1_CPD_XPC_XR_2.bed.csv",
    "TS_NHF1_CPD_XR_1.bed.csv",
    "TS_NHF1_CPD_XR_2.bed.csv",
]
