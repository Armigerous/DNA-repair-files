...
# Load the datasets
csb_data = pd.read_csv("data\TS_NHF1_CPD_CSB_XR_1.bed.csv")
...
# Train the models
csb_model = LinearRegression().fit(X_train, y_csb_train)
xpc_model = LinearRegression().fit(X_train, y_xpc_train)
